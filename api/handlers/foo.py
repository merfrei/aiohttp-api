...
from api.handlers import get_base_get
from api.handlers import get_base_post
from api.handlers import get_base_put
from api.handlers import get_base_delete
from api.models.foo import FooDB
